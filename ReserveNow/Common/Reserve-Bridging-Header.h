...
//  Gofer
//
//  Created by Trioangle Technologies on 29/03/17.
...
#define           USER_PROMO_CODE           @"Promo_Code"
...
#define           USER_WORK_LOCATION        @"work_loc"
#define           USER_HOME_LOCATION        @"home_loc"
#define           USER_WORK_LATITUDE        @"work_latitude"
#define           USER_WORK_LONGITUDE       @"work_longitude"
#define           USER_WALLET_AMOUNT        @"wallet_amount"
#define           USER_PAYMENT_METHOD       @"payment_method"
#define           USER_SELECT_WALLET        @"selectwallet"
#define           USER_PAYPAL_APP_ID        @"paypal_app_id"
#define           USER_PAYPAL_MODE          @"paypal_mode"
#define           USER_HOME_LATITUDE        @"home_latitude"
#define           USER_HOME_LONGITUDE       @"home_longitude"
...
#define           USER_CARD_LAST4           @"user_credit_card_sufix"
#define           USER_CARD_BRAND           @"user_credit_card_brand"
#define           PAYPAL_WALLET_PAYMENT     @"user_paypal_default_wallet_payment"
#define           STRIPE_WALLET_PAYMENT     @"user_stripe_default_wallet_payment"
